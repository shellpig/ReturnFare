...
| P4-C 委託 UI 與首個案例 | ✅ | 委託候選／預覽／確認、第一張人物卡教學、D17～19 處方案例均已實作；K-124／K-125 結案，25 套 headless 全綠；完整 UI sim 102／102 variants、79／79 contracts、0 failed，11 條負向反證如期失敗，七條驗收全打勾 |
